...
- [Power BI documentation - Power BI | Microsoft Docs](https://docs.microsoft.com/en-us/power-bi/)
- [Data Analysis Expressions (DAX) Reference - DAX | Microsoft Docs](https://docs.microsoft.com/en-us/dax/)
